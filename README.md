...
if you want it to apply only to a specific work).
Click Create Skin.
Give it a unique title (e.g. "LOTM — The Fool").
Paste the entire contents of CSS into the
CSS field.

What's in the file:


:root variables — all colors are defined once at the top
(--lotm-bg, --lotm-gold, --lotm-paper, etc.) and reused
everywhere else. Change a color here and it updates across the
whole skin.
